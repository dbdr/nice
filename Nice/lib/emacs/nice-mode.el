...
+\\s-*\\<\\(\\w+\\)\\>\\s-*:"
   ...
   ;; Keywords
   '("\\<\\(fun\\|static\\|final\\|const\\|extends\\|implements\\|abstract\\|public\\|private\\|var\\|class\\|interface\\|new\\|else\\|native\\|inline\\|import\\|require\\|package\\|alike\\|Any\\|return\\|break\\|continue\\|try\\|catch\\|finally\\|throw\\|instanceof\\)\\>\\|@\\|=>"
     0 nice-keyword-face)
