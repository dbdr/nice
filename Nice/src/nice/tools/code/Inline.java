...
//$Modified: Tue Jul 25 12:33:33 2000 by Daniel Bonniot $
...
{
  public static Expression inline1(Procedure1 proc, Expression arg1)
  {
    return new ApplyExp(proc, new Expression[]{ arg1 });
  }

  public static Expression inline2(Procedure2 proc, Expression arg1,
				   Expression arg2)
  {
